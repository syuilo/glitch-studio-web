...
test('multiple output rendering', async t => {
	...
	function setup(t, nodes, history = false) {
		...
		const renderer = new Renderer({ gpuDevice: device, gpuContext: context, histogramGpuContext: context, waveformGpuContext: context, resolution: { width: 16, height: 16 }, enableFloat32Filtering: false, enableStats: false, fpsLimit: null, assets: [], macros: [], automations: [], nodes });
